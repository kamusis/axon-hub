---
name: content-lab
description: Pre-launch content optimization lab. Generates 50+ variants of any conversion-focused content, scores with a 5-expert simulated panel, evolves winners through multiple rounds, and outputs the optimized version plus a full experiment log. Use when optimizing landing pages, email sequences, ad copy, headlines, form pages, or CTA text. Triggers on "optimize this page", "run content lab", "score these variants", "A/B test this copy", "optimize copy".
version: 1.1.0
display_name: "content-lab"
display_name_en: "Content Lab"
description_zh: "上线前内容优化实验室，50+ 变体 + 专家评分 + 进化迭代"
description_en: "Pre-launch content optimization lab with 50+ variants, expert scoring, and evolution"
visibility: "public"
---

# Content Lab

Pre-launch optimization lab for any conversion-focused content. No traffic needed. Simulated expert panel. Minutes, not weeks.
...
> **The sequence:** Run Content Lab FIRST to hit 85+ simulated score. Then deploy. Then validate with real traffic.
...
Score every variant against all 5 personas in one pass.
...
Round 1:
  ...
  → Score all 10 with the 5-expert panel
...
### Step 2: Run Optimization Rounds

For each element, run the round structure above. Generate all variants in one batch, then score them all in one pass.

### Step 3: Cross-Breed (Multi-Element)
...
```json
{
  "run_id": "content-lab-{name}-{timestamp}",
...
- **Generate and score variants in batches.** Never generate one variant at a time — produce all 10 variants together, then score them all together.
